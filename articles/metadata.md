...
```
    ...
    ##  - attr(*, "source")= Named chr [1:2] "/tmp/RtmpTTEXmF/git2rdata-metadata160b34885bdd/iris.tsv" "/tmp/RtmpTTEXmF/git2rdata-metadata160b34885bdd/iris.yml"
...
```
    ...
    ## Title: NA
    ## Description: NA
    ## Path: /tmp/RtmpTTEXmF/git2rdata-metadata160b34885bdd/iris.tsv (9282fad022c924c16a76bd8b3c174e71fc4515fe), /tmp/RtmpTTEXmF/git2rdata-metadata160b34885bdd/iris.yml (f5eda4fcbe143eefc267a51a511110c604848272)
...
```
    ...
    ## Path: /tmp/RtmpTTEXmF/git2rdata-metadata160b34885bdd/iris.tsv (9282fad022c924c16a76bd8b3c174e71fc4515fe), /tmp/RtmpTTEXmF/git2rdata-metadata160b34885bdd/iris.yml (a8e8987f123e0aea13157081b03b47f2b039b1bf)
    ## Sorting order: Sepal.Length
    ## Optimized storage: TRUE
    ## Variables:
    ##   - Sepal.Length: The length of the sepal in cm
