...
- [`write_vc()`](https://ropensci.github.io/git2rdata/reference/write_vc.md)
  gains an optional `convert` argument for specifying column
...
- [`read_vc()`](https://ropensci.github.io/git2rdata/reference/read_vc.md)
  now applies conversions specified in the metadata and adds the convert
  information to the data frame attributes.
- Bugfix in
  [`rename_variable()`](https://ropensci.github.io/git2rdata/reference/rename_variable.md)
  thanks to [@florisvdh](https://github.com/florisvdh) for finding and
  fixing the bug.
